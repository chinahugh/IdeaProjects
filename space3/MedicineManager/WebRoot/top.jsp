    ...
    <tr>
        <td colspan="2">
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                ...
                <tr>
                    <td height="140" valign="top" width="556"><img src="images/top1.jpg" width="556" height="140"
                                                                   border="0"></td>
                    <td width="100%"></td>
                    <td width="245" height="140" valign="top"><img src="images/top3.jpg" width="245" height="140"
                                                                   border="0"
                                                                   usemap="#Map"></td>
                </tr>
            </table>
