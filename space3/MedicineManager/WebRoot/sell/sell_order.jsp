                        ...
                        <logic:present name="order" scope="session">
                            <logic:iterate id="ele" name="order" scope="session">
                                <tr bgcolor="#FFFFFF">
                                    ...
                                    <td>
                                        <html:link href="sell.do?command=deleteOrder" paramId="id" paramName="ele"
                                                   paramProperty="id">
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td colspan="5" align="center">
                                    <html:link href="../baseData/med.do?command=canSellMeds"><bean:message
                                            key="system.goon"/></html:link>
                                    <html:link href="sell.do?command=clear"><bean:message
                                            key="system.clear"/></html:link>
                                    <html:link href="sell.do?command=buy"><bean:message key="sell.buy"/></html:link>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <bean:message key="system.total"/>&nbsp;<bean:write name="sum" scope="session"
                                                                                        format="###,###.##"/>&nbsp;
                                    <bean:message key="system.money"/>
                                </td>
                            </tr>
