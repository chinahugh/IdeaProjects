                            ...
                            <logic:notEmpty name="list" scope="request">
                                <logic:iterate id="ele" name="list" scope="request" indexId="index">
                                    <tr bgcolor="#FFFFFF">
                                        <td>${index+1}</td>
                                        <td>
                                            <html:link href="sell.do?command=findByMedId" paramId="id" paramName="ele"
                                                       paramProperty="medId">
                                        ...
                                        <td>
                                            <html:link href="../require/require.do?command=update" paramId="id"
                                                       paramName="ele" paramProperty="medId">进货</html:link>
                                            <html:link href="../baseData/med.do?command=view" paramId="id"
                                                       paramName="ele" paramProperty="medId">查看药品</html:link>
                                        </td>
                                    </tr>
                                </logic:iterate>
                            </logic:notEmpty>
