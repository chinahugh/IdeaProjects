                        ...
                        <tr bgcolor="#FFFFFF">
                            <td colspan="9" align="center">
                                <table border="0" width="100%">
                                    <tr>
                                        <td align="left">
                                            <form name="medForm" action='<html:rewrite page="/baseData/med.do"/>'
                        ...
                        <form action='<html:rewrite page="/baseData/deleteMedicineAction.do"/>' method='post'>
                            <logic:iterate id="ele" name="list" scope="request">
                                <tr bgcolor="#FFFFFF">
                                    ...
                                    <td>
                                        <html:link href="med.do?command=view" paramId="id" paramName="ele"
                                                   paramProperty="id">
                                    ...
                                    <td>
                                        <html:link href="../require/require.do?command=update" paramId="id"
                                                   paramName="ele" paramProperty="id">
                                            <bean:message key="system.stock"/>
                                        </html:link>
                                        <html:link href="med.do?command=edit" paramId="id" paramName="ele"
                                                   paramProperty="id">
