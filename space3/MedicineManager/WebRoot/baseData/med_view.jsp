                        ...
                        <table border="1" align="center" width="700" cellpadding="1" cellspacing="1" bgcolor="#036500"
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td align="center" colspan="4" height="40">
                                    <html:link href="med.do?command=edit" paramId="id" paramName="med"
                                               paramProperty="id">
                                ...
                                <td rowspan="7" width="350" align="center" valign="middle">
                                    ...
                                    <logic:notEmpty name="med" property="photoPath">
                                        <img src="../upload/<bean:write name='med' property='photoPath'/>" width="320"
                                             height="220"/>
                                    </logic:notEmpty>
                                </td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td class="tb_tl2" align="right" width="70">ID£º</td>
                                <td align="left"><bean:write name="med" property="id"/></td>
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.req.count"/>£º
                                </td>
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.category"/>£º
                                </td>
                                <td align="left"><bean:write name="med" property="category.name"/></td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td class="tb_tl2" align="right" width="70"><bean:message key="medicine.factoryAdd"/>£º
                                </td>
                                <td align="left" colspan="3"><bean:write name="med" property="factoryAdd"/></td>
                            </tr>
                            <tr bgcolor="#FFFFFF" height="40">
                                <td class="tb_tl2" align="right" width="70"><bean:message
                                        key="medicine.description"/>£º
                                </td>
