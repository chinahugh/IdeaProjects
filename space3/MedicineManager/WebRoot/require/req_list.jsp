                        ...
                        <tr bgcolor="#FFFFFF">
                            <td colspan="9" align="center">
                                <table border="0" width="100%">
                                    <tr>
                                        <td align="left">
                                            <form name="queryForm" action='<html:rewrite page="/require/require.do"/>'
                                                  method="post" onsubmit="return blurQuery();" class="blur_form">
                                                <input type="hidden" name="command" value="blurQuery"/>
                                                <bean:message key="system.blur.query"/>£º<input name="keyWord"
                                                                                               type="text" size="20"/>
                                ...
                                <tr bgcolor="#FFFFFF">
                                    <td>
                                        <input type="hidden" name="allId"
                                               value='<bean:write name="ele" property="id" />'>
                                    ...
                                    <td>
                                        <html:link href="../baseData/med.do?command=view" paramId="id" paramName="ele"
                                                   paramProperty="id">
                                    ...
                                    <td>
                                        <html:link href="require.do?command=edit" paramId="id" paramName="ele"
                                                   paramProperty="id">
                                            <bean:message key="system.modify"/>
                                        </html:link>
                                        <html:link href="require.do?command=meded" paramId="id" paramName="ele"
                                                   paramProperty="id">
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td colspan="9" align="right">
                                    <table border="0" width="100%">
                                        <tr>
                                            <td>
                                                <html:submit property="command"><bean:message
                                                        key="button.delete.selected"/></html:submit>
