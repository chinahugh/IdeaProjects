        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
                <td bgcolor="#FFFFFF" height="50">
                    <br>
                    <html:form action="require/require.do" method="post" focus="name" enctype="multipart/form-data"
                        ...
                        <table border="0" align="center" width="500">
                                        ...
                                        <select name="categoryId" id="categoryId">
                                            <logic:notEmpty name="cs" scope="request">
                                                <logic:iterate id="ele" name="cs" scope="request">
                                                    ...
                                                    <logic:notEqual value="${ele.id}" name="medForm"
                                                                    property="categoryId">
                                                        <option value="<bean:write name='ele' property='id' />">
                                                            <bean:write name="ele" property="name"/>
                                                        </option>
                            ...
                            <tr>
                                ...
                                <td align="left"><html:textarea property="factoryAdd" cols="30"
                                                                rows="3"></html:textarea></td>
                            </tr>
                            <tr>
                                <td align="right"><bean:message key="medicine.description"/>£º</td>
                                <td align="left"><html:textarea property="description" cols="30"
                                                                rows="3"></html:textarea></td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center"><html:submit><bean:message
