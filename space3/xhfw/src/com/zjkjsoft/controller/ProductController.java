...
public class ProductController extends BaseController {
	private static String path="/scxx/product/";//jsp路径
	//navTabId
	private static String navTabId="product";
	...
	public void index() {
		...
		if(keywords!=null&&!"".equals(keywords))
			sql="from product where "+key+" like '%"+keywords+"%' order by id desc";	
