...
public class Cpgx5Controller extends BaseController {
	private static String path="/xtpz/cpgx5/";//jsp路径
	//navTabId
	private static String navTabId="cpgx5";
	...
	@Override
	public void index() {
		setAttr("treeJSStr", PageElement.getTreeC1("select id,mc from product where  id>? order by id desc", Integer.valueOf(0), "cpgx5/list/","cpgx5Box", "mc"));
	...
	private Page<Cpjcjd> getPageData()
	{
		...
		String sql="from cpjcjd  where  lx=5 and fid ="+getParaToInt();
