...
public class Cpgx2Controller extends BaseController {
	private static String path="/xtpz/cpgx2/";//jsp路径
	//navTabId
	private static String navTabId="cpgx2";
	...
	@Override
	public void index() {
		setAttr("treeJSStr", PageElement.getTreeC1("select id,mc from product where  id>? order by id desc", Integer.valueOf(0), "cpgx2/list/","cpgx2Box", "mc"));
	...
	private Page<Cpjcjd> getPageData()
	{
		...
		String sql="from cpjcjd  where lx=2 and  fid ="+getParaToInt();
