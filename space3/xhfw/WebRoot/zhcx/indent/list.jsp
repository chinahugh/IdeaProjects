...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="componentsCX/{sid_user}" rel="jcxxcomponents" target="navTab"><span>订单组件</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody><%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" ondblclick="view('indentCX/view/${o.id}')" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
