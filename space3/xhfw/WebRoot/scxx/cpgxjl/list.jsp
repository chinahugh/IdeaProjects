...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" href="productCX/listw/{sid_user}" target="navTab"><span>工序记录</span></a></li>
			<li><a class="icon" href="productCX/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody><%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
				...
				<td style="text-align:left;">${o.pmc}</td>
				<td style="text-align:left;">${o.lx>4?"包装":(o.lx>3?"绑定":(o.lx>2?"检测":(o.lx>1?"测试":"加工")))}</td>
