...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="jcxxmaterial/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="jcxxmaterial/add" target="navTab"><span>添加</span></a></li>
			<c:if test="${flag==1 }">
				<li><a class="delete" href="jcxxmaterial/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			</c:if>
			<li><a class="edit" href="jcxxmaterial/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="jcxxmaterial/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
			<!-- <li><a class="icon" href="jcxxmaterial/importFile" target="navTab"><span>导入EXCEL</span></a></li> -->
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" ondblclick="view('jcxxmaterial/view/${o.id}')" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
