...
条码：<input  type="text" name="txm" id="txm" size="30" value="${cpjc.txm}"> <input type="submit" value="查询" >
故障码：<input  type="text" name="czm" id="czm" value=""> <input type="submit" value="保存" >
...
<tr>
<th width="5%">序号</th><th width="15%">订单</th><th width="15%">条码</th><th width="15%">物料</th><th width="10%">故障码</th><th width="20%">备注</th><th>时间</th>
</tr>
