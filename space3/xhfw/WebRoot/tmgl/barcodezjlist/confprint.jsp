...
<div class="pageContent">
	<div class="panelBar">
		...
		<!-- 	<li><a class="edit" href="barcodezjlist/{sid_user}" target="navTab"><span>查看条码</span></a></li> -->
			<li><a target="navTab" rel="ids" postType="string" name="ids" href="barcodezjlist/print" 
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<c:forEach items="${page.list}" var="o">
				<tr target="sid_user" rel="${o.id}" ondblclick="view('barcodezjlist/confprint/${o.id}')"
