...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="componentsbind/{sid_user}" rel="componentsbind" target="navTab"><span>订单组件</span></a></li>
			<li><a class="edit" href="binding/add/{sid_user}" target="navTab"><span>绑定配置</span></a></li>
		</ul>
	</div>
