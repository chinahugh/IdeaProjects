...
<div class="pageContent">
	<form method="post" action="barcodezj/print" onsubmit="return navTabSearch(this);">
		<div class="pageFormContent" layoutH="56">
			<fieldset>
				...
				<fieldset>
					<legend>打印物料：</legend>
					<dl>
						<input name="" value="${jcxxcomponents.wlh}" readonly="readonly" size="30">
					</dl>
					<dl>
						<input name="" value="${jcxxcomponents.wlms}" readonly="readonly" size="50">
					</dl>
					<dl>
						<input name="id" value="${jcxxcomponents.id}" type="hidden" readonly="readonly" size="5">
					</dl>
				</fieldset>
				<fieldset>
					<legend>条码配置：</legend>
