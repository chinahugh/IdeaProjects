...
<div class="pageHeader">
	<form  id="pagerForm" method="post" action="wd" onsubmit="return navTabSearch(this);"  >
...
<div class="pageContent">
	...
	<div class="panelBar">
		<div class="pages">
			<span>显示</span>
			<select  style="padding:1px " name="numPerPage" onchange="navTabPageBreak({numPerPage:this.value})">
