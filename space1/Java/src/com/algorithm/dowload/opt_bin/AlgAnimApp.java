package com.algorithm.dowload.opt_bin;/* AlgAnimApp.java */
...
/**
 * This class creates an applet on a java compliant browser. There
...
public class AlgAnimApp extends Applet {
     ...
     */
    public void init() {
			System.out.println("init: AlgAnimApp");
      ...
      validate();
			System.out.println("init: AlgAnimApp - exit");
		}
    ...
    public boolean action(Event e, Object arg) {
    	Object target = e.target;
			System.out.println("AlgAnimApp: action called"); 
			if (target == start_button) {
				System.out.println("AlgAnimApp: start button hit"); 
