package com.algorithm.dowload.common;/* ControlPanel class */
 ...
 * namely, <code>run, stop, step,</code> and <code>skip</code>.
 *
 * @see Panel
 */
public class ControlPanel extends Panel {
		...
		/**
		 * Perform a <code>repaint()</code> on each of the image buttons.
		 */
	...
	return true;
		...
		/**
		 * Returns an instance of the run <code>ImageButton</code>, which is
		 * casted to <code>java.awt.Button</code>
		...
		/**
		 * Returns an instance of the stop <code>ImageButton</code>, which is
		 * casted to <code>java.awt.Button</code>
		...
		/**
		 * Returns an instance of the step <code>ImageButton</code>, which is
		 * casted to <code>java.awt.Button</code>
		...
		/**
		 * Returns an instance of the skip <code>ImageButton</code>, which is
		 * casted to <code>java.awt.Button</code>
