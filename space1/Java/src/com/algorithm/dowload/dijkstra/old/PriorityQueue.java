package com.algorithm.dowload.dijkstra.old;
...
class PriorityQueue {
	...
	public void Remove_Element( Node n ) {
		...
		for (i = 0; i < dests.size(); i++) {
			...
			System.out.println("PQ: i = "+i+", node "+at.Get_ID()+", node "+n.Get_ID());
			if (at == n) {
				break;
				}
			}	
	...
	public void Sort( int pivot_pos, int num_items) {
		...
		*/
		i = final_pivot_pos + 1;
		System.out.println("Sort: num_items = "+num_items+", f_p_p = "+final_pivot_pos);
