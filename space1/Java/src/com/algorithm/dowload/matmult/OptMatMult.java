package com.algorithm.dowload.matmult;

import com.algorithm.dowload.common.*;
...
//----------------------------------------------------------------
	...
	DrawingObj p1 = new Parenthesis(s1, drawingPanel.getFixFont());
	DrawingObj p2 = new Parenthesis(s2, drawingPanel.getFixFont());
	...
	DrawingObj box = new FloatingBox(""+
		(dims[left].height*dims[c_index+1].height*dims[right].width),
		drawingPanel.getFixFont());
