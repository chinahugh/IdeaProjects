...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="bom/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<!-- <li><a class="add" href="bom/add" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="bom/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="bom/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>-->
			<li><a class="icon" href="bom/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li> 
			<li><a class="icon" href="bom/importFile" target="navTab"><span>导入EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" ondblclick="view('bom/view/${o.id}')" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
