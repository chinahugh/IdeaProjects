...
<form method="post" action="srgx/save" class="pageForm required-validate" onsubmit="return validateCallback(this)">					<!--#include virtual="list1.html" -->
...
<input name="srp.id" type="hidden" size="30"  value="${id}" />
