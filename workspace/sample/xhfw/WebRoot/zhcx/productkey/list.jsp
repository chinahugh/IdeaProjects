	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				...
				<td>
					物料图号：<input type="text" name="wlth" value="${param.wlth}" size="20" />
				</td>
				<td>
					规格型号：<input type="text" name="ggxh" value="${param.ggxh}" size="20" />
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="productkeyCX/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="icon" href="productkeyCX/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
