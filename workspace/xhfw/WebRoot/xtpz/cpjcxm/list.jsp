...
<div class="pageHeader">
	<form  id="pagerForm"  action="cpjcxm/${fid }"  method="post"  onsubmit="return navTabSearch(this);"  >
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="cpjcxm/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="cpjcxm/add/${fid }" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="cpjcxm/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="cpjcxm/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="cpjcxm/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
