...
(function($){
	$.fn.extend({
		pagination: function(opts){
			var setting = {
				first$:"li.j-first", prev$:"li.j-prev", next$:"li.j-next", last$:"li.j-last", 
			...
			return this.each(function(){
				...
				//var  ks=(pc.getCurrentPage()-7>0?pc.getCurrentPage()-7:1);//zk add 20131217  由于页面超过15页不显示
				//var  js=(pc.getCurrentPage()+7<interval.end?pc.getCurrentPage()+7:interval.end);
				var pageNumFrag = '';
				//for (var i=ks; i<js;i++){
