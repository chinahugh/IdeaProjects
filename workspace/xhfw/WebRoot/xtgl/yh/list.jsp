...
<div class="pageHeader">
	<form  id="pagerForm" onsubmit="return navTabSearch(this);" action="suser" method="post">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					员工姓名：<input type="text" name="keywords" value="${param.keywords}" size="20"/>
				</td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="suser/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="suser/add" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="suser/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="suser/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="suser/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody><%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" ondblclick="view('suser/view/${o.id}')" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
