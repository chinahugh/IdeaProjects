...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					角色名称：<input type="text" name="keywords" value="${param.keywords}" size="20" />
				</td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="srole/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="srole/add" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="srole/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="srole/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="srole/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
