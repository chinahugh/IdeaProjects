...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					名称：<input type="text" name="keywords" value="${param.keywords}" size="20" />
				</td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<!-- <li><a class="edit" href="sms/view/{sid_user}" target="navTab"><span>查看</span></a></li> -->
			<li><a class="add" href="sms/add?tjtype=sxm&wxts=${wxts}" target="navTab"><span>添加</span></a></li>
			<!-- <li><a class="delete" href="sms/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="sms/edit/{sid_user}" target="navTab"><span>修改</span></a></li>  -->
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody><%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" <%-- ondblclick="view('fucn/view/${o.id}')"  --%>class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
				...
				<td style="text-align:left;">${o.phoneNumber}</td>
				</c:if>
				<td style="text-align:left;">${o.smsContent}</td>
                <td style="text-align:left;">
                <fmt:formatDate value="${o.sendTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                </td>
