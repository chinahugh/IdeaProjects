...
<form method="post" action="srcs/save" class="pageForm required-validate" onsubmit="return validateCallback(this)">					<!--#include virtual="list1.html" -->
...
<input name="srcs.id" type="hidden" size="30"  value="${id}" />
