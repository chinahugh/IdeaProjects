...
<div class="pageContent">
	<form method="post" action="cpgx1jl/save" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<fieldset>
			...
			<dl >
				<dt>条形码：</dt>
				<dd>
				<input name="cpjcjl.txm" class="required" type="text" size="25" value="${cpjc.txm}" />
				<input name="cpjcjl.fid"  type="hidden" size="25" value="${product.id}" />
				<input  name="cpjcjl.xh"  type="hidden" size="25" value="${cpjc.xh==null?1:cpjc.xh}" />
