...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					产品编号：<input type="text" name="keywords" value="${param.keywords}" size="20" />
				</td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="testboard/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="testboard/add" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="testboard/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="testboard/edit/{sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="testboard/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody><%boolean isEvenLine = false;%> 
			...
			<tr target="sid_user" rel="${o.id}" ondblclick="view('role/view/${o.id}')" class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
				...
				<td style="text-align:left;">${o.czsj}</td>			
