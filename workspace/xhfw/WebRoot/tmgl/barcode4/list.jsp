		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>物料描述：<input type="text" name="wlms" value="${param.wlms}" size="20" />
					</td>
...
<div class="pageContent">
	<div class="panelBar">
		...
		<!-- 	<li><a class="edit" href="jcxxindent/view/{sid_user}" target="navTab"><span>查看</span></a></li> -->
			<li><a class="edit" href="barcodelist/{sid_user}" target="navTab"><span>条码查看</span></a></li>
			<li><a class=icon href="barcode/confprint/{sid_user}" target="navTab"><span>生成条码</span></a></li>
			<li><a class=edit href="barcodereceive/{sid_user}" target="navTab"><span>领取人</span></a></li>
		</ul>
	</div>
