		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>打印状态：<td><select class="combox" name="status">
...
<div class="pageContent">
	<form method="post" action="barcodezjlist/printconf" rel="ids" name="ids" onsubmit="return navTabSearch(this);">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="edit" href="barcodezjlist/view/{sid_user}" target="navTab"><span>查看</span></a></li>
				<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" name="ids" href="barcodezjlist/delete" class="delete"><span>批量删除</span></a></li>
			</ul>
		</div>
		<div class="formBar">
			<ul>
		...
		<table class="table" width="100%" layoutH="138">
			...
			<tbody>
				...
				<c:forEach items="${page.list}" var="o">
					<tr target="sid_user" rel="${o.id}" ondblclick="view('barcodezjlist/view/${o.id}')"
