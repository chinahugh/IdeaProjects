...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="barcodezjreceive/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="barcodezjreceive/add/${fid}" target="navTab"><span>添加</span></a></li>
			<!--  <li><a class="edit" href="barcodezjreceive/edit/{sid_user}" target="navTab"><span>修改</span></a></li>  -->
			<li><a class="delete" href="barcodezjreceive/delete/{sid_user}"target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<c:forEach items="${page.list}" var="o">
				<tr target="sid_user" rel="${o.id}" ondblclick="view('barcodezjreceive/view/${o.id}')"class="<%=(isEvenLine) ? "tr2" : "tr1"%>">
