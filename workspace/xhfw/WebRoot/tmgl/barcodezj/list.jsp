...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<!-- 	<li><a class="edit" href="jcxxcomponents/view/{sid_user}" target="navTab"><span>查看</span></a></li> -->
			<li><a class="edit" href="barcodezjlist/{sid_user}" target="navTab"><span>条码查看</span></a></li>
			<li><a class="edit" href="barcodezj/confprint/{sid_user}" target="navTab"><span>生成条码</span></a></li>
			<li><a class=edit href="barcodezjreceive/{sid_user}" target="navTab"><span>领取人</span></a></li>
		</ul>
	</div>
