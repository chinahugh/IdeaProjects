...
function load() {
	setTimeout(function(){
		divSearch(pagerForm123,'binding1');
	}, 2000);
}
</script>
<div class="pageHeader">
	<form  id="pagerForm" name="pagerForm123" method="post"  action="binding/list2/${dd}-${fwlh}" onsubmit="return divSearch(this,'binding1');"  >
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="binding/delete/{sid_user}" target="ajaxTodo" title="确定要删除吗?" onclick="load();"><span>删除</span></a></li>
		</ul>
	</div>
