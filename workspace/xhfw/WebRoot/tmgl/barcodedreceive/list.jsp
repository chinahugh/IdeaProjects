...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="barcodedreceive/view/{sid_user}" target="navTab"><span>查看</span></a></li>
			<li><a class="add" href="barcodedreceive/add/${fid}" target="navTab"><span>添加</span></a></li>
			<!--  <li><a class="edit" href="barcodereceive/edit/{sid_user}" target="navTab"><span>修改</span></a></li>  -->
			<li><a class="delete" href="barcodedreceive/delete/{sid_user}"target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
		</ul>
	</div>
