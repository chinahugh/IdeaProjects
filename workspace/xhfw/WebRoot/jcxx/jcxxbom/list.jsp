...
<div class="pageHeader">
	<form  id="pagerForm" method="post" action="jcxxbom/list/${wlh }-${fid}-${bbh}" rel="jcxxbomBox1"  onsubmit="return divSearch(this,'jcxxbomBox1');"  >
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<c:if test="${flag==1 }">
				<li><a class="delete" href="jcxxbom/delete/{sid_user}" target="ajaxTodo" onclick="load()" rel="jcxxbomdel" title="确定要删除吗?"><span>删除</span></a></li>
			</c:if>
	...
	<table class="table" width="100%" layoutH="170" rel="jcxxbomBox1">
		<thead>									
			<tr>
				<th >组件</th>
				<th >组件描述</th>
