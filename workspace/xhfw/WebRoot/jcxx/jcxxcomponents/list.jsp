...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<%-- <li><a class="add" href="jcxxcomponents/add/${dd}" target="navTab"><span>添加</span></a></li>
			<c:if test="${flag==1 }">
			...
			<!-- <li><a class="icon" href="jcxxcomponents/export" target="dwzExport"   title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li> -->
		</ul>
	</div>
