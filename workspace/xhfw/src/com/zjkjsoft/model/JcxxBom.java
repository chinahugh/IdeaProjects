...
public class JcxxBom extends Model<JcxxBom> {
	...
	public static String searchTree(ProBbh probbh,String wlh) {
		Product product=Product.dao.findById(probbh.getInt("fid"));
		String str1="",str2="",str3="";
		str3=PageElement.getTreeBom("select wlh,wlms,zj,zjms,bbh,fid from jcxxbom where fid="+probbh.get("fid")+" and bbh="+probbh.get("bbh")+" and wlh=? order by id",wlh, "jcxxbom/list/", "jcxxbomBox1","zj","bbh","zjms");
		String strs[]=new String[10];
		int j=0;
		String wlh1=wlh;
		for (int i = 0; i < strs.length; i++,j++) {
