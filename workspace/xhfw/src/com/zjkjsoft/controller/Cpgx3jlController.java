...
public class Cpgx3jlController extends BaseController {
	private static String path="/scxx/cpgx3jl/";//jsp路径
	//navTabId
	private static String navTabId="cpgx3jl";
	...
	private Page<Cpjcjl> getPageData()
	{
		...
		String sql="from cpjcjl a, cpjcjd b where a.fid=b.fid and a.lx=b.lx and a.xh=b.xh and  a.lx=3  ";
		//管理员  1
		//部门领导
		//操作者
	...
	{
		String keywords=getPara("keywords");
		String sql="from cpjcjl where lx=3  ";
		//管理员  1
		//部门领导
		//操作者
		if("管理员".equals(getSessionAttr("username"))) {
	 ...
	 */
	public void view() {
		String sql=" select a.*,b.mc from cpjcjl a, cpjcjd b where a.fid=b.fid and a.lx=b.lx and a.xh=b.xh and  a.lx=3 and a.id=? ";
...
toDwzJson(200,"新增操作成功",navTabId,"","closeCurrent");
	...
	public void export() throws UnsupportedEncodingException {
		...
		String filename = new String("产品检测.xls".getBytes("UTF-8"), "ISO8859-1");
