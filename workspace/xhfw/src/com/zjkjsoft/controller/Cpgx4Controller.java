...
public class Cpgx4Controller extends BaseController {
	private static String path="/xtpz/cpgx4/";//jsp路径
	//navTabId
	private static String navTabId="cpgx4";
	...
	@Override
	public void index() {
		setAttr("treeJSStr", PageElement.getTreeC1("select id,mc from product where  id>? order by id desc", Integer.valueOf(0), "cpgx4/list/","cpgx4Box", "mc"));
	...
	private Page<Cpjcjd> getPageData()
	{
		...
		String sql="from cpjcjd  where  lx=4 and fid ="+getParaToInt();
