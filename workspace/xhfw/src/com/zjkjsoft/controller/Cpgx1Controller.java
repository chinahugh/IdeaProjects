...
public class Cpgx1Controller extends BaseController {
	private static String path="/xtpz/cpgx1/";//jsp路径
	//navTabId
	private static String navTabId="cpgx1";
	...
	@Override
	public void index() {
		setAttr("treeJSStr", PageElement.getTreeC1("select id,mc from product where  id>? order by id desc", Integer.valueOf(0), "cpgx1/list/","cpgx1Box", "mc"));
	...
	private Page<Cpjcjd> getPageData()
	{
		...
		String sql="from cpjcjd  where lx=1 and fid ="+getParaToInt();
