...
public class BarcodeReceiveController extends BaseController {
	private static String path = "/tmgl/barcodereceive/";// jsp路径
	// navTabId
	private static String navTabId = "barcodereceive";
...
System.out.println("fidd"+getParaToInt());
	...
	private Page<BarcodeReceive> getPageData() {
		String sql = " from barcodeReceive where tag=1 and fid= '" + getPara()+"'";
