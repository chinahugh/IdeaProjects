...
public class Cpgx3Controller extends BaseController {
	private static String path="/xtpz/cpgx3/";//jsp路径
	//navTabId
	private static String navTabId="cpgx3";
	...
	@Override
	public void index() {
		setAttr("treeJSStr", PageElement.getTreeC1("select id,mc from product where  id>? order by id desc", Integer.valueOf(0), "cpgx3/list/","cpgx3Box", "mc"));
	...
	private Page<Cpjcjd> getPageData()
	{
		...
		String sql="from cpjcjd  where  lx=3 and fid ="+getParaToInt();
