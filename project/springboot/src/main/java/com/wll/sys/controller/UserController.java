...
import com.wll.sys.service.UserRoleService;
import com.wll.sys.service.UserService;
import com.wll.sys.util.PasswordHelper;
...
public class UserController {
    ...
    public String saveUserRoles(UserRole userRole){
        if(StringUtils.isEmpty(String.valueOf(userRole.getUserid()))) {
            return "error";
        }
        try {
